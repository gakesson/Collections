...
/**
 * This is an implementation which decorates a {@link Queue} with a bounded
 * limit. This is useful when behavior to restrict excessive queue expansion is
 * needed. Taking the bounded limit decoration aside, this implementation's
...
public class BoundedQueue<E> extends AbstractQueue<E>
{
    ...
    /**
     * Creates a new {@link Queue} instance using the provided backing queue and
     * maximum capacity.
     * 
     * @param backingQueue
     ...
     * immediately without violating capacity restrictions of this queue or the
     * backing queue.
     * 
     * @param e
     *            The element to add.
     * @return {@code true} if the element was added to the backing queue, else
     *         {@code false}.
     * @throws {@link NullPointerException} if the specified element is null and
     *         the backing queue does not permit null values.
     * @throws {@link IllegalArgumentException} if some property of this element
    ...
    /**
     * Adds all of the elements in the specified collection to the backing
     ...
     * element returned by the iterator to the backing queue, in turn. A runtime
     * exception encountered while trying to add an element (including, in
     * particular, a {@code null} element) may result in only some of the
     * elements having been successfully added when the associated exception is
     * thrown.
     * 
     * In case the provided collection's size plus the current size of the
     * backing queue exceeds the {@link BoundedQueue}'s capacity, an
     * {@link IllegalStateException} will be thrown. At that point, no elements
     * have been inserted in the backing queue.
     * 
     * @param collectionToAdd
     *            The collection containing elements to be added to this queue.
     * @return {@code true} if this queue changed as a result of the call.
     * @throws {@link NullPointerException} If the specified collection contains
     *         a null element and the backing queue does not permit null
     *         elements, or if the specified collection is null.
     * @throws {@link IllegalArgumentException} If some property of an element
     *         of the specified collection prevents it from being added to this
     *         queue, or if the specified collection is this queue.
     * @throws {@link IllegalStateException} If not all or any of the elements
     *         can be added at this time due to insertion restrictions.
     * @see #add(Object)
     */
    @Override
     ...
     * 
     * @return The head of the queue, or {@code null} if the backing queue is
     *         empty.
     */
    @Override
    public E poll()
     ...
     * {@code null} if the queue is empty.
     * 
     * @return The head of this queue, or <tt>null</tt> if the backing queue is
     *         empty.
     */
    @Override
    public E peek()
